...
python $dir/../thunderlaser.py $ids --tab="advanced" --speed=30 --minpower1=7 --maxpower1=18 --smoothness=0.2 --freq1=20 --maxwidth=900 --maxheight=600 --bbox_only=false --dummy=false $svg
