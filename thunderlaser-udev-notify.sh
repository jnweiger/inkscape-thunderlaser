#! /bin/sh
# thunderlaser-udev-notify.sh -- a helper triggered by thunderlaser.rules RUN= 
#
...
title="Thunderlaser RUIDA ($ACTION)"
text="use via inkscape -> Extensions -> Export"
test "$ACTION" = 'add' || text=
timeout=10000		# Milliseconds
icon=printer
icon=/lib/udev/thunderlaser-icon.png	# Ubuntu path
